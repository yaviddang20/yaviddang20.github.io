 ...
 */ class LayoutChildComponent extends Component {
    ...
    constructor(...args){
        super(...args), /** @private */ this._minWidth = 0, /** @private */ this._minHeight = 0, /**
     * @type {number|null}
     * @private
     */ this._maxWidth = null, /**
     * @type {number|null}
     * @private
     */ this._maxHeight = null, /** @private */ this._fitWidthProportion = 0, /** @private */ this._fitHeightProportion = 0, /** @private */ this._excludeFromLayout = false;
    }
}
